...
def func(save_dir=r'../outputs',vocab=r'../outputs/vocabulary.txt',train=r'../outputs/train-data.npz',
         valid=r'../outputs/valid-data.npz',bidirectional=1,batch_size=32,num_epochs=1,learning_rate=0.001,
         dropout_keep=1.0,interval=1000,lstm_units=500,embedding_size=100,in_embeddings=None,in_train_embeddings=False):
    ...
    model = seq.seq2seqModel(lstm_units,
                             ...
                             bidirectional=bidirectional,condition=True)
    ...
    model.train(sess, save_dir, train_data, valid_data, batch_size,
                num_epochs, learning_rate,
                dropout_keep, 5.0, report_interval=interval)
    pass
if __name__ == '__main__':
    ...
    model = seq.seq2seqModel(args.lstm_units,
                                        embeddings, wd.eos_index,
                                        train_embeddings=train_embeddings,
